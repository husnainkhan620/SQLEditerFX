...
public class ThreeLineHorizontal  extends ERModel{
	...
	public ThreeLineHorizontal(double startX,double startY,double lineLenght,Pane mainPane) {

	
		group = new Group();
		Px1 = startX;Py1 = startX;Px2 = Px1+lineLenght;Py2 = Py1;
		...
		mainPane.getChildren().addAll(linePleftCircle,lineQCenterCircle,lineRRightCircle,group);
