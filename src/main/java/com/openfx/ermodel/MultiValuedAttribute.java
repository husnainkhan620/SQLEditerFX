...
public class MultiValuedAttribute extends ERModel{
	...
	public MultiValuedAttribute(double radiusX,double radiusY,double layoutX,double layoutY,Pane mainPane) {
	...
	//	stackPaneRectangle.setBorder(new Border(new BorderStroke(Color.GAINSBORO, BorderStrokeStyle.DASHED, null, null))); 
		...
		innerEllipse = new Ellipse(radiusX -12,radiusY -12);
		innerEllipse.setStrokeWidth(2);
		innerEllipse.setStroke(Color.BLACK);
		innerEllipse.setFill(Color.GAINSBORO);
	
		textAreaEllipse = new TextArea();
		textAreaEllipse.setText(" MULTIVALUED\n  ATTRIBUTE");
		textAreaEllipse.setFont(Font.font("System Regular",FontPosture.REGULAR, 16));
		textAreaEllipse.setMaxSize(innerEllipse.getRadiusX() + 0.45*innerEllipse.getRadiusX(), innerEllipse.getRadiusY() + 0.40*innerEllipse.getRadiusY());
		textAreaEllipse.setId("mytextarea");
		textAreaEllipse.setWrapText(true);
		stackPaneRectangle.getChildren().addAll(resizeRectangle,newEllipse,innerEllipse,textAreaEllipse);
		...
		stackPaneRectangle.setOnMouseExited(event ->{
		   ...
		   leftAnchor.setOnMouseEntered((event) -> {
	        ...
	        leftAnchor.setOnMouseDragged((event) -> {
	            ...
	            innerEllipse.setRadiusX(resizeRectangle.getWidth()/2 -12 );
	            textAreaEllipse.setMaxSize(innerEllipse.getRadiusX() + 0.45*innerEllipse.getRadiusX(), innerEllipse.getRadiusY() + 0.40*innerEllipse.getRadiusY());
	        ...
	        bottomleftAnchor.setOnMouseDragged((event) -> {
	            ...
	            innerEllipse.setRadiusY(resizeRectangle.getHeight()/2 -12 );
	            newEllipse.setRadiusX(resizeRectangle.getWidth()/2);
	            innerEllipse.setRadiusX(resizeRectangle.getWidth()/2 -12 );
	            textAreaEllipse.setMaxSize(innerEllipse.getRadiusX() + 0.45*innerEllipse.getRadiusX(), innerEllipse.getRadiusY() + 0.40*innerEllipse.getRadiusY());
