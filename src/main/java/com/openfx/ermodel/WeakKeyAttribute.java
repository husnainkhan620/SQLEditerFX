...
public class WeakKeyAttribute extends ERModel {
	...
	public WeakKeyAttribute(double radiusX,double radiusY,double layoutX,double layoutY,Pane mainPane) {
	...
	//	stackPaneRectangle.setBorder(new Border(new BorderStroke(Color.GAINSBORO, BorderStrokeStyle.DASHED, null, null))); 
		...
		textAreaEllipse.setText("   WEAKKEY\n    ATTRIBUTE   ");
