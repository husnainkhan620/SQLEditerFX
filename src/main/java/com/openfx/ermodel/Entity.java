...
public class Entity  extends ERModel {
		...
		stackPaneRectangle.setOnMouseExited(event ->{
		   ...
		   leftAnchor.setOnMouseEntered((event) -> {
	        ...
	        leftAnchor.setOnMouseDragged((event) -> {
	            ...
	            newRectangle.setWidth(resizeRectangle.getWidth()-4);
	            textAreaRecatangle.setMaxSize(newRectangle.getWidth() - 0.15*newRectangle.getWidth(), newRectangle.getHeight() - 0.15*newRectangle.getHeight());
	        ...
	        bottomleftAnchor.setOnMouseDragged((event) -> {
	            ...
	            // re- align the innerRectanle and text area
	            newRectangle.setHeight(resizeRectangle.getHeight()-4);
	            newRectangle.setWidth(resizeRectangle.getWidth()-4);
	            textAreaRecatangle.setMaxSize(newRectangle.getWidth() - 0.15*newRectangle.getWidth(), newRectangle.getHeight() - 0.15*newRectangle.getHeight());
	...
	public TextArea getTextAreaRecatangle() {
		return textAreaRecatangle;
	}
