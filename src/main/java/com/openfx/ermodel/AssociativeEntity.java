...
public class AssociativeEntity extends ERModel {
	...
	public AssociativeEntity(double width,double height,double layoutX,double layoutY,Pane mainPane) {
		double rhombusSize =  height/2;
		...
		textAreaRecatangle.setText(" Associate ");
		textAreaRecatangle.setFont(Font.font("System Regular",FontPosture.REGULAR, 16));
		textAreaRecatangle.setMaxSize(rhombusSize*2 + 0.50*rhombusSize, rhombusSize - 0.50*rhombusSize);
		textAreaRecatangle.setId("mytextarea");
		textAreaRecatangle.setWrapText(true);
		stackPaneRectangle.getChildren().addAll(resizeRectangle,outerRectangle,rhombus,textAreaRecatangle);
		...
		stackPaneRectangle.setOnMouseExited(event ->{
		 ...
		 leftAnchor.setOnMouseEntered((event) -> {
	        ...
	        leftAnchor.setOnMouseDragged((event) -> {
	            ...
	            rhombus.getPoints().addAll(rhombusSizevalues);
	            textAreaRecatangle.setMaxSize( (rightAnchor.getCenterX() - leftAnchor.getCenterX())/2,(bottomAnchor.getCenterY() - topAnchor.getCenterY())/2 );
