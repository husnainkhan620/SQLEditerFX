...
public class WeakEntity extends ERModel {
	...
	public WeakEntity(double width,double height,double layoutX,double layoutY,Pane mainPane) {
		
		leftAnchor = new Circle(layoutX, layoutY+height/2, 5);
		 
		topLeftAnchor = new Circle(layoutX,layoutY,5);
		bottomleftAnchor = new Circle(layoutX ,layoutY+height, 5);
		 
		topAnchor = new Circle(layoutX+width/2,layoutY , 5);
		bottomAnchor = new Circle(layoutX+width/2, layoutY + height, 5);
		    
	    topRightAnchor = new Circle(layoutX+width, layoutY, 5);
		rightAnchor = new Circle(layoutX+width, layoutY+height/2, 5);
	    bottomRightAnchor = new Circle(layoutX+width,layoutY+height,5);
		...
		outerRectangle.setFill(Color.GAINSBORO);
		outerRectangle.setStrokeWidth(2);
		outerRectangle.setStroke(Color.BLACK);
		
		innerRectangle = new Rectangle(width-12,height-12);
		innerRectangle.setFill(Color.GAINSBORO);
		innerRectangle.setStrokeWidth(2);
		innerRectangle.setStroke(Color.BLACK);
		
		textAreaRecatangle = new TextArea();
		textAreaRecatangle.setText("Weak \n Entity");
		textAreaRecatangle.setFont(Font.font("System Regular",FontPosture.REGULAR, 16));
		textAreaRecatangle.setMaxSize(outerRectangle.getWidth() - 0.15*outerRectangle.getWidth(), outerRectangle.getHeight() - 0.15*outerRectangle.getHeight());
		textAreaRecatangle.setId("mytextarea");
		textAreaRecatangle.setWrapText(true);
		
		stackPaneRectangle.getChildren().addAll(resizeRectangle,outerRectangle,innerRectangle,textAreaRecatangle);
		...
		stackPaneRectangle.setOnMouseExited(event ->{
		 ...
		 leftAnchor.setOnMouseEntered((event) -> {
	        ...
	        leftAnchor.setOnMouseDragged((event) -> {
	            ...
	            outerRectangle.setWidth(resizeRectangle.getWidth()-4);
	            innerRectangle.setWidth(resizeRectangle.getWidth() -16  );
	            textAreaRecatangle.setMaxSize(outerRectangle.getWidth() - 0.15*outerRectangle.getWidth(), outerRectangle.getHeight() - 0.15*outerRectangle.getHeight());
	        ...
	        bottomleftAnchor.setOnMouseDragged((event) -> {
	            ...
	            // re- align the innerRectanle and text area
	            outerRectangle.setHeight(resizeRectangle.getHeight()-4);
	            outerRectangle.setWidth(resizeRectangle.getWidth()-4);
	            innerRectangle.setHeight(resizeRectangle.getHeight() -16);
	            innerRectangle.setWidth(resizeRectangle.getWidth() - 16);
	            textAreaRecatangle.setMaxSize(outerRectangle.getWidth() - 0.15*outerRectangle.getWidth(), outerRectangle.getHeight() - 0.15*outerRectangle.getHeight());
	        ...
	        bottomRightAnchor.setOnMouseDragged((event) -> {
	            ...
	            bottomRightAnchor.setCenterY((stackPaneRectangle.getLayoutY() + resizeRectangle.getHeight()) );//AnewRectangledjust the left circle with the growth of the rectangle
	...
	public Circle getLeftAnchor() {
		return leftAnchor;
	}


	public Circle getTopLeftAnchor() {
		return topLeftAnchor;
	}


	public Circle getBottomleftAnchor() {
		return bottomleftAnchor;
	}


	public Circle getTopAnchor() {
		return topAnchor;
	}


	public Circle getBottomAnchor() {
		return bottomAnchor;
	}


	public Circle getTopRightAnchor() {
		return topRightAnchor;
	}


	public Circle getRightAnchor() {
		return rightAnchor;
	}


	public Circle getBottomRightAnchor() {
