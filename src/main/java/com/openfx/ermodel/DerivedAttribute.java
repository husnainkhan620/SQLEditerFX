...
public class DerivedAttribute extends ERModel {
	...
	public DerivedAttribute(double radiusX,double radiusY,double layoutX,double layoutY,Pane mainPane) {
	...
	//	stackPaneRectangle.setBorder(new Border(new BorderStroke(Color.GAINSBORO, BorderStrokeStyle.DASHED, null, null))); 
		...
		newEllipse.getStrokeDashArray().addAll(20d);
		...
		textAreaEllipse.setText("   DERIVED \n   ATTRIBUTE   ");
